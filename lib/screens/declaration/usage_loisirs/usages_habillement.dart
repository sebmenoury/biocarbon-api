...
class UsagesHabillementScreen extends StatefulWidget {
  final String codeIndividu;
  final VoidCallback onSave;
  final String sousCategorie;
  final String valeurTemps;

  const UsagesHabillementScreen({super.key, required this.codeIndividu, required this.sousCategorie, required this.valeurTemps, required this.onSave});

  @override
  State<UsagesHabillementScreen> createState() => _UsagesHabillementScreenState();
}

class _UsagesHabillementScreenState extends State<UsagesHabillementScreen> {
  ...
  Future<void> loadData() async {
    ...
    final existants = postes.where((p) => p.sousCategorie == 'Habillement').toList();
    ...
    final refFiltree = ref.where((e) => e['Sous_Categorie'] == 'Habillement').toList();
      ...
      children: [
        if (isLoading)
          ...
          const Padding(
            ...
            child: Text(
              "⚙️ Indiquez ici vos dépenses globales Habillements de l'année. \n"
